...
notion_dividendscreener = importlib.import_module("myNotionDividendScreener") if weekdaynum==4 else print(f"Today is day {weekdaynum}: No screener set up for today") # only screen on fridays
